...
def validate_first_run_setup(
    ...
    # Blank optional fields are valid wildcards. Setup proves that the profile
    # is saved and a source works; advisories explain risky or contradictory
    # combinations without turning omissions into blockers.
