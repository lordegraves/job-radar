...
- Current field-test build: `RC6 Build 1.6`
...
capabilities and are not implemented in RC6 Build 1.6. Diagnostics still
...
The resulting `artifacts\installer\Junior-Setup-0.2.0-RC6-build-1.6.exe` installs under the
