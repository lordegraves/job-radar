...
- a 50-employer starter catalog on new and upgraded installations; it adds no
  ...
  only once so a company the user removes stays removed; first-run setup guides
  users through testing every not-yet-tested source without checkboxes before
